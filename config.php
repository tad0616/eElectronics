...
//連結顏色[theme_css.html]
$config_enable['link_color'] = array('enable' => '1', 'min' => '', 'max' => '', 'require' => '0', 'default' => '#1abc9c');

//移到連結顏色[theme_css.html]
$config_enable['hover_color'] = array('enable' => '1', 'min' => '', 'max' => '', 'require' => '0', 'default' => '#17a78b');
...
$config_enable['bt_text_size'] = array('enable' => '1', 'min' => '', 'max' => '', 'require' => '0', 'default' => '30px');
...
$config_enable['block_title_style'] = array('enable' => '1', 'min' => '', 'max' => '', 'require' => '0', 'default' => 'border:none;height:40px;line-height:40px;margin-bottom:10px;text-align: center;font-weight: normal;');
...
$config_enable['navbar_bg_top'] = array('enable' => '1', 'min' => '', 'max' => '', 'require' => '0', 'default' => '#1ABC9C');

//導覽工具列 漸層顏色(bottom)[theme_css_navbar.html]
$config_enable['navbar_bg_bottom'] = array('enable' => '0', 'min' => '', 'max' => '', 'require' => '0', 'default' => '#1ABC9C');

//導覽工具列 連結區塊底色[theme_css_navbar.html]
$config_enable['navbar_hover'] = array('enable' => '1', 'min' => '', 'max' => '', 'require' => '0', 'default' => '#17a78b');
